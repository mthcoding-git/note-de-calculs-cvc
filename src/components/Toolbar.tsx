...
const DISPLAY_OPTIONS = [
  ...
  { key: 'dn',                label: 'DN',                       calcIds: ['bouclage-ecs', 'alimentation-ecs', 'alimentation-ef', 'distribution-chauffage', 'distribution-eauglacee'] },
  { key: 'dn',                label: 'Dimension',                calcIds: ['distribution-ventilation'] },
  ...
  { key: 'debitFoisonne',     label: 'Débit foisonné',           calcIds: ['distribution-ventilation'] },
  { key: 'coeffFois',         label: 'Coeff. foisonnement',      calcIds: ['distribution-ventilation'] },
